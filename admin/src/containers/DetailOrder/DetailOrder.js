...
class DetailOrder extends Component {
  ...
  onChangeInput = (event, newValue, field) => {
    ...
    let isValid = false;
    isValid = checkValidity(this.state.orderForm[field].elements.getOptionLabel ? this.state.orderForm[field].elements.getOptionLabel(newValue) : event.target.value, this.state.orderForm[field].validation)
    const newElementInput = {
      elements: {
        ...this.state.orderForm[field].elements,
        value: newInput
    ...
    console.log("orderFormUpdated", orderFormUpdated)
    this.setState({
      orderForm: orderFormUpdated,
